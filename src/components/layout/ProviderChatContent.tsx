...
const ProviderChatContent = () => {
  const { t, i18n } = useTranslation();
  const [conversations, setConversations] = useState<Conversation[]>([
    {
      id: '1',
      clientName: 'সামী রহমান',
      clientAvatar: 'SR',
      lastMessage: 'আপনার গিগ সম্পর্কে আরও জানতে চাই',
      ...
      messages: [
        ...
        { id: 'm3', role: 'client', content: 'আপনার গিগ সম্পর্কে আরও জানতে চাই', timestamp: '10:30 AM' }
      ]
    },
    {
      id: '2',
      clientName: 'জয়া হোসেন',
      clientAvatar: 'JH',
      ...
      messages: [
        ...
        { id: 'm6', role: 'client', content: 'ধন্যবাদ, আমি শীঘ্রই জানাব', timestamp: 'Yesterday 4:00 PM' }
      ]
    },
    {
      id: '3',
      clientName: 'মিতু রহমান',
      clientAvatar: 'MR',
      ...
      isActive: false,
      messages: [
        { id: 'm7', role: 'client', content: 'আপনার রেটিং দেখে খুবই আগ্রহী', timestamp: '2 days ago' }
      ]
    }
  ]);
      ...
      <Stack spacing={4}>
        <Box>
          <Typography variant="h3" fontWeight={700} mb={1}>
            {t('pages.providerDashboard.sidebar.menu.3.label')}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('pages.providerDashboard.sidebar.menu.3.hint')}
          </Typography>
        </Box>
                      ...
                      <Stack spacing={2}>
                        {activeConversation.messages.map((message) => (
                          <Box
                            ...
                            sx={{
                              display: 'flex',
                              justifyContent: message.role === 'provider' ? 'flex-end' : 'flex-start'
                            }}
                          >
                            <Box
                              sx={{
                                ...
                                p: 1.5,
                                borderRadius: 2,
                                bgcolor: message.role === 'provider' ? 'primary.main' : 'background.paper',
                                color: message.role === 'provider' ? 'primary.contrastText' : 'text.primary',
                                boxShadow: 1
                              }}
                            >
                              ...
                              <Typography
                                ...
                                sx={{
                                  ...
                                  mt: 0.5,
                                  opacity: 0.7,
                                  textAlign: message.role === 'provider' ? 'right' : 'left'
                                }}
                              >
                                {message.timestamp}
                              </Typography>
...
export default ProviderChatContent;
