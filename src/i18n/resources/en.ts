const en = {
  ...
  forms: {
    provider: {
      ...
      nid: 'NID (optional)',
      nidVerified: 'NID verified successfully'
    },
    client: {
    ...
    home: {
      ...
      personas: {
        ...
        sokti: {
          ...
          detail:
            'Sokti is the red/pink companion for women providers: it suggests gig copy, pricing ideas, and safety reminders so you can focus on earning with confidence.',
          bullets: [
