...
const draftTemplates: Record<string, DraftResponse> = {
  tailoring: {
...
export const mockDraftGig = async (payload: DraftPayload): Promise<DraftResponse> => {
  await wait(900);
...
export const mockSuggestPrice = async (payload: PricePayload): Promise<number> => {
  await wait(700);
